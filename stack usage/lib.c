 ...
 * 22 Apr 05  T Lill	corrected error in limit-check of hex characters
 * 28 Nov 06  T Lill	Updated _itoa and _atoi to allow negative numbers.
 * 04 Apr 07  T Lill	Added a dummy variable to avoid a warning in _atoi().
 ******************************************************************************/
#include "string.h"
#include "lib.h"
...
void _itoa(char **buf, int i, int base)
{
     ...
     * This is converter to an ASCII character and saved in "rev".
     *
